...
public class CharaValueDialogFragment extends DialogFragment {
	...
	public static final String TAG = CharaValueDialogFragment.class
			.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View dialogLayout = View.inflate(mActivity,
				R.layout.dialogfrag_charavalue, null);
		mValueText = (TextView) dialogLayout.findViewById(R.id.valueText);
		mProgressBar = (ProgressBar) dialogLayout
				.findViewById(R.id.valueProgress);
