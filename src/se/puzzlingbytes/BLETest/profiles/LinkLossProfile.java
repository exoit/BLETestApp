...
public class LinkLossProfile {
	...
	public static final UUID LINK_LOSS_SERVICE_UUID = ProfileUtils
			.generateStandardUUID("1803");

	public static final UUID ALERT_LEVEL_UUID = ProfileUtils
			.generateStandardUUID("2A06");
	...
	public static int readAlertLevel(
