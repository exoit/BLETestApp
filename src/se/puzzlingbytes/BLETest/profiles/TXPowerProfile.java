...
public class TXPowerProfile {
	...
	public static final UUID TX_POWER_SERVICE_UUID = ProfileUtils
			.generateStandardUUID("1804");

	public static final UUID TX_POWER_LEVEL_UUID = ProfileUtils
			.generateStandardUUID("2A07");
	...
	public static int readTxPowerLevel(
			BluetoothGattCharacteristic bluetoothGattCharacteristic) {
		Log.d("TXPowerProfile",
