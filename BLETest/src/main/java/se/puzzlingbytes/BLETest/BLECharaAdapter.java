...
public class BLECharaAdapter extends ArrayAdapter<BluetoothGattCharacteristic> {
    ...
    @Override
    public void addAll(Collection<? extends BluetoothGattCharacteristic> collection) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.primaryText
                .setText(ProfileUtils
                        .lookupUUIDName(bluetoothGattCharacteristic.getUuid(), "Unknown"));
        viewHolder.secondaryText
                .setText(translateProperties(
                        bluetoothGattCharacteristic.getProperties()) + (bluetoothGattCharacteristic
                        .getPermissions() > 0 ? "," + translatePermission(
    ...
    public boolean isEnabled(int position) {
        BluetoothGattCharacteristic bluetoothGattCharacteristic = getItem(position);
        BigInteger biProperties = BigInteger.valueOf(bluetoothGattCharacteristic.getProperties());
