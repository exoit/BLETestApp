...
public class BatteryProfile {
    ...
    public static final UUID BATTERY_SERVICE_UUID = ProfileUtils.generateStandardUUID("180F");

    public static final UUID BATTERY_LEVEL_UUID = ProfileUtils.generateStandardUUID("2A19");
